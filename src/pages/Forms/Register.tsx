...
export default function Register() {
  ...
  const NigerianMinisteries = [
    ...
    },
    {
      ...
      value: 'MINISTRY OF ENERGY, MINES AND ENVIROMENT (MOROCCO)',
    },
    {
      label: 'MINISTRY OF EQUIPMENT, TRANSPORT AND LOGISTICS (MOROCCO)',
    ...
    {
      label:
        'MINISTRY OF TOURISM, AIR TRANSPORT, CRAFT AND SOCIAL ECONOMY (MOROCCO)',
      value:
        'MINISTRY OF TOURISM, AIR TRANSPORT, CRAFT AND SOCIAL ECONOMY (MOROCCO)',
    },
    {
